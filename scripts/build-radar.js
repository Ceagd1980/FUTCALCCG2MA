...
// Esta variante del script muestra los partidos de MAÑANA (el día
// siguiente al de la corrida), independientemente de a qué hora corra
// el robot. Es la única diferencia respecto a build-radar.js del sitio
// de "hoy" — todo el resto del cálculo (1X2, PPG, Ataque/Defensa, etc.)
// es idéntico.
...
function main() {
  ...
  console.log(`Filtrando partidos de mañana, ${objetivo} (hora Ecuador)...`);
